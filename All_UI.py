...
class AlarmClockApp(App):
    ...
    def build(self):
    	...
    	self.Timer_widget= Timer_widget = HeaderLables(size_hint=[1/5, 1])
    	Timer_widget.img1.source='icons8-alarm-clock-96.png'
    	Timer_widget.btn1.bind(on_release=self.GoTOTimer_widget)
    	...
    	ToolBar.add_widget(Timer_widget)
